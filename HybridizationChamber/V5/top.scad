        ...
        difference(){
            ...
            difference(){
                ...
                difference(){
                    ...
                    translate([0,0,-6.25])cylinder(r=20.5, h=1.75, $fn=500);//1.25 mm
                }
            ...
            for (pos=[-17.5:35:17.5]){
                translate([pos, 0, -3])english_thread(diameter = (1/4+1/128), threads_per_inch = 28, length = 6.1/25.4, inner=true);
            }
        }
        for (theta=[0:90:270]){
            rotate([0,0,theta])translate([21, 0, -7])cylinder(r=0.5, h=1, $fn=500);
        }
    }
}
top();
