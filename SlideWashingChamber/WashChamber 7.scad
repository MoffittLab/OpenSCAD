...
// December 22, 2015//Modified January 26, 2016//Modified February 11, 2016//Modified February 26, 2016//Modified July 1, 2016//Modified July 11, 2016
        ...
        union(){
            ...
            for (pos=[3:2.5:55]){
                union(){
                    ...
                    translate([42.5, pos, 0])cube(size=([5,1,50]));
                }
            }
        }
        //Add version mark
        translate([40,5,0])mirror([1,0,0])drawtext("JRM 7");
    }
...
module cover(){
    union(){//Add latches
        ...
        translate([19,26,2])difference(){ //Create handle
