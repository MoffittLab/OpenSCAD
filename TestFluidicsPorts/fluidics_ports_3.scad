...
difference(){
    difference(){
        ...
        translate([-5, 0, -4.5])english_thread(diameter = (1/4+1/32), threads_per_inch = 28, length = 1/2, inner=true);
    }
    translate([5, 0, 0])english_thread(diameter = (1/4+1/32), threads_per_inch = 28, length = 1/4, inner=true);
}
